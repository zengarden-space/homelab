...
**Access:**
```
URL: https://notifications.homelab.zengarden.space
Username: admin
Password: <from victoria-metrics/env.yaml>
```
...
3. URL: `https://notifications.homelab.zengarden.space`
4. Username: `admin`
...
**Web UI:**
1. Navigate to `https://notifications.homelab.zengarden.space`
