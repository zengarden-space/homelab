...
gotify:
  ...
  token: "<will-be-generated-after-deployment>"
```
...
**Verify from home network (VLAN88):**
```bash
...
4. Add hostnames:
   - `*.homelab.zengarden.space` → `https://ingress-nginx-external-controller.external-tunnel.svc:443`
...
### 5.3 Verify ArgoCD ApplicationSet
...
**ApplicationSet should auto-discover apps from manifests/ repo directories**
