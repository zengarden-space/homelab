...
- **Initial investment**: ~$1000-1500 (one-time)
...
> "Initial investment matters not that much as a running cost that determines sustainability."
...
- [**Network Design**](/networking) - VLANs, DNS, and security boundaries
