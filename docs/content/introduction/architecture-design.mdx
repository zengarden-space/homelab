...
│  Network   │    Network     │   Network        │  10.8.0.0/24  │
│  eth2+eth3 │    eth4        │    eth5          │               │
└─────┬──────┴────────────────┴──────────────────┴───────────────┘
      │
...
| **WireGuard** | 10.8.0.0/24 | VPN clients | Access to cluster + pod/service networks, blocked from home/mgmt |
...
└── platform/       # AppProject: platform (core platform)
    └── prod/       # Namespace prefix: platform-prod-*
```
