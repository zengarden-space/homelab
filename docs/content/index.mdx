...
- **Enterprise security** - OIDC authentication, VLAN isolation, hardened containers
...
- **Open** - All code available at [GitHub/zengarden-space](https://github.com/zengarden-space/)
