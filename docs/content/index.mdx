...
<Image src={`${process.env.NEXT_PUBLIC_BASE_PATH ?? ''}/images/homelab-arch.svg`} alt="Homelab Overview" width={1200} height={600} />
...
├── docs/                          # Next.js documentation site (this site)
├── platform/
...
- **Open** - All code available at [github.com/oleksiyp/homelab](https://github.com/oleksiyp/homelab)
